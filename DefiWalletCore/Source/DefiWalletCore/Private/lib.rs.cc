...
#ifndef CXXBRIDGE1_STRUCT_org$defi_wallet_core$StringTuple
#define CXXBRIDGE1_STRUCT_org$defi_wallet_core$StringTuple
struct StringTuple final {
  ::rust::String value;
  ::rust::String error;

  using IsRelocatable = ::std::true_type;
};
#endif // CXXBRIDGE1_STRUCT_org$defi_wallet_core$StringTuple
...
::rust::String broadcast_tx(::rust::String tendermint_rpc_url,
                            ::rust::Vec<::std::uint8_t> raw_signed_tx) {
...
new_wallet(::rust::String password) {
  ...
  ::rust::repr::PtrLen error$ =
      org$defi_wallet_core$cxxbridge1$new_wallet(&password, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
