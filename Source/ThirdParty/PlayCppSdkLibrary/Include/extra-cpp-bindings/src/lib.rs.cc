...
struct WalletconnectClient final : public ::rust::Opaque {
  /// setup callback
  ///
  void setup_callback_blocking(::std::unique_ptr<::com::crypto::game_sdk::WalletConnectCallback> usercallback);
  ...
  ::rust::Vec<::std::uint8_t> sign_eip155_transaction_blocking(::com::crypto::game_sdk::WalletConnectTxEip155 const &info, ::std::array<::std::uint8_t, 20> address);

  /// send cronos(eth) eip155 transaction
  /// Supported Wallets: Trust Wallet, MetaMask and Crypto.com Mobile Defi Wallet
  ::rust::Vec<::std::uint8_t> send_eip155_transaction_blocking(::com::crypto::game_sdk::WalletConnectTxEip155 const &info, ::std::array<::std::uint8_t, 20> address);

  /// eip1559_transaction_request: json string of Eip1559TransactionRequest
  /// return signed transaction bytes
  ::rust::Vec<::std::uint8_t> sign_transaction(::rust::String eip1559_transaction_request, ::std::array<::std::uint8_t, 20> address);

  /// eip1559_transaction_request: json string of Eip1559TransactionRequest
  /// return transaction hash bytes
  ::rust::Vec<::std::uint8_t> send_transaction(::rust::String eip1559_transaction_request, ::std::array<::std::uint8_t, 20> address);
  ...
  /// }
  /// return signed transaction bytes
  ::rust::Vec<::std::uint8_t> sign_contract_transaction(::rust::String contract_action, ::com::crypto::game_sdk::WalletConnectTxCommon const &common, ::std::array<::std::uint8_t, 20> address);
  ...
  ///     }
  /// }
  ::rust::Vec<::std::uint8_t> send_contract_transaction(::rust::String contract_action, ::com::crypto::game_sdk::WalletConnectTxCommon const &common, ::std::array<::std::uint8_t, 20> address);
...
struct Walletconnect2Client final : public ::rust::Opaque {
  ::com::crypto::game_sdk::WalletConnect2EnsureSessionResult ensure_session_blocking(::std::uint64_t waitmillis);
...
extern "C" {
void com$crypto$game_sdk$cxxbridge1$WalletConnectCallback$onConnected(::com::crypto::game_sdk::WalletConnectCallback const &self, ::com::crypto::game_sdk::WalletConnectSessionInfo const &sessioninfo) noexcept {
  void (::com::crypto::game_sdk::WalletConnectCallback::*onConnected$)(::com::crypto::game_sdk::WalletConnectSessionInfo const &) const = &::com::crypto::game_sdk::WalletConnectCallback::onConnected;
  (self.*onConnected$)(sessioninfo);
}

void com$crypto$game_sdk$cxxbridge1$WalletConnectCallback$onDisconnected(::com::crypto::game_sdk::WalletConnectCallback const &self, ::com::crypto::game_sdk::WalletConnectSessionInfo const &sessioninfo) noexcept {
  void (::com::crypto::game_sdk::WalletConnectCallback::*onDisconnected$)(::com::crypto::game_sdk::WalletConnectSessionInfo const &) const = &::com::crypto::game_sdk::WalletConnectCallback::onDisconnected;
  (self.*onDisconnected$)(sessioninfo);
}

void com$crypto$game_sdk$cxxbridge1$WalletConnectCallback$onConnecting(::com::crypto::game_sdk::WalletConnectCallback const &self, ::com::crypto::game_sdk::WalletConnectSessionInfo const &sessioninfo) noexcept {
  void (::com::crypto::game_sdk::WalletConnectCallback::*onConnecting$)(::com::crypto::game_sdk::WalletConnectSessionInfo const &) const = &::com::crypto::game_sdk::WalletConnectCallback::onConnecting;
  (self.*onConnecting$)(sessioninfo);
}

void com$crypto$game_sdk$cxxbridge1$WalletConnectCallback$onUpdated(::com::crypto::game_sdk::WalletConnectCallback const &self, ::com::crypto::game_sdk::WalletConnectSessionInfo const &sessioninfo) noexcept {
  void (::com::crypto::game_sdk::WalletConnectCallback::*onUpdated$)(::com::crypto::game_sdk::WalletConnectSessionInfo const &) const = &::com::crypto::game_sdk::WalletConnectCallback::onUpdated;
...
void com$crypto$game_sdk$cxxbridge1$WalletConnectSessionInfo$set_chainid(::com::crypto::game_sdk::WalletConnectSessionInfo &self, ::rust::String const *chainid) noexcept {
...
void com$crypto$game_sdk$cxxbridge1$WalletConnectSessionInfo$set_accounts(::com::crypto::game_sdk::WalletConnectSessionInfo &self, ::rust::Vec<::rust::String> const *accounts) noexcept {
...
void com$crypto$game_sdk$cxxbridge1$WalletConnectSessionInfo$set_bridge(::com::crypto::game_sdk::WalletConnectSessionInfo &self, ::rust::String const *bridge) noexcept {
...
void com$crypto$game_sdk$cxxbridge1$WalletConnectSessionInfo$set_key(::com::crypto::game_sdk::WalletConnectSessionInfo &self, ::rust::String const *key) noexcept {
...
void com$crypto$game_sdk$cxxbridge1$WalletConnectSessionInfo$set_clientid(::com::crypto::game_sdk::WalletConnectSessionInfo &self, ::rust::String const *clientid) noexcept {
...
void com$crypto$game_sdk$cxxbridge1$WalletConnectSessionInfo$set_clientmeta(::com::crypto::game_sdk::WalletConnectSessionInfo &self, ::rust::String const *clientmeta) noexcept {
...
void com$crypto$game_sdk$cxxbridge1$WalletConnectSessionInfo$set_peerid(::com::crypto::game_sdk::WalletConnectSessionInfo &self, ::rust::String const *peerid) noexcept {
...
void com$crypto$game_sdk$cxxbridge1$WalletConnectSessionInfo$set_peermeta(::com::crypto::game_sdk::WalletConnectSessionInfo &self, ::rust::String const *peermeta) noexcept {
...
void com$crypto$game_sdk$cxxbridge1$WalletConnectSessionInfo$set_handshaketopic(::com::crypto::game_sdk::WalletConnectSessionInfo &self, ::rust::String const *handshaketopic) noexcept {
...
bool com$crypto$game_sdk$cxxbridge1$RawTxDetail$operator$eq(RawTxDetail const &, RawTxDetail const &) noexcept;
bool com$crypto$game_sdk$cxxbridge1$RawTokenResult$operator$eq(RawTokenResult const &, RawTokenResult const &) noexcept;
bool com$crypto$game_sdk$cxxbridge1$TokenHolderDetail$operator$eq(TokenHolderDetail const &, TokenHolderDetail const &) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$filter_wallets(bool cached, ::rust::String *registry_local_path, ::com::crypto::game_sdk::Platform platform, ::rust::Vec<::com::crypto::game_sdk::WalletEntry> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$get_all_wallets(bool cached, ::rust::String *registry_local_path, ::rust::Vec<::com::crypto::game_sdk::WalletEntry> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$check_wallet(bool cached, ::rust::String *registry_local_path, ::rust::String *id, ::com::crypto::game_sdk::Platform platform, bool *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$get_wallet(bool cached, ::rust::String *registry_local_path, ::rust::String *id, ::com::crypto::game_sdk::WalletEntry *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$generate_qrcode(::rust::String *qrcodestring, ::com::crypto::game_sdk::WalletQrcode *return$) noexcept;
...
::std::size_t com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$operator$sizeof() noexcept;
::std::size_t com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$operator$alignof() noexcept;
...
::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$walletconnect2_restore_client(::rust::String *session_info, ::rust::Box<::com::crypto::game_sdk::Walletconnect2Client> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$walletconnect_new_client(::rust::String *description, ::rust::String *url, ::rust::Vec<::rust::String> *icon_urls, ::rust::String *name, ::std::uint64_t chain_id, ::rust::Box<::com::crypto::game_sdk::WalletconnectClient> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$walletconnect2_client_new(::rust::String *relayserver, ::rust::String *project_id, ::rust::String *required_namespaces, ::rust::String *client_meta, ::rust::Box<::com::crypto::game_sdk::Walletconnect2Client> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$WalletconnectClient$setup_callback_blocking(::com::crypto::game_sdk::WalletconnectClient &self, ::com::crypto::game_sdk::WalletConnectCallback *usercallback) noexcept;
...
::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$ensure_session_blocking(::com::crypto::game_sdk::Walletconnect2Client &self, ::std::uint64_t waitmillis, ::com::crypto::game_sdk::WalletConnect2EnsureSessionResult *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$poll_events_blocking(::com::crypto::game_sdk::Walletconnect2Client &self, ::std::uint64_t waitmillis, ::rust::String *return$) noexcept;
...
::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$get_connection_string(::com::crypto::game_sdk::Walletconnect2Client &self, ::rust::String *return$) noexcept;
...
::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$save_client(::com::crypto::game_sdk::Walletconnect2Client &self, ::rust::String *return$) noexcept;
...
::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$print_uri(::com::crypto::game_sdk::Walletconnect2Client &self, ::rust::String *return$) noexcept;
...
::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$sign_personal_blocking(::com::crypto::game_sdk::Walletconnect2Client &self, ::rust::String *message, ::std::array<::std::uint8_t, 20> *address, ::rust::Vec<::std::uint8_t> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$ping_blocking(::com::crypto::game_sdk::Walletconnect2Client &self, ::std::uint64_t waitmillis, ::rust::String *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$WalletconnectClient$sign_eip155_transaction_blocking(::com::crypto::game_sdk::WalletconnectClient &self, ::com::crypto::game_sdk::WalletConnectTxEip155 const &info, ::std::array<::std::uint8_t, 20> *address, ::rust::Vec<::std::uint8_t> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$sign_eip155_transaction_blocking(::com::crypto::game_sdk::Walletconnect2Client &self, ::com::crypto::game_sdk::WalletConnectTxEip155 const &info, ::std::array<::std::uint8_t, 20> *address, ::rust::Vec<::std::uint8_t> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$WalletconnectClient$send_eip155_transaction_blocking(::com::crypto::game_sdk::WalletconnectClient &self, ::com::crypto::game_sdk::WalletConnectTxEip155 const &info, ::std::array<::std::uint8_t, 20> *address, ::rust::Vec<::std::uint8_t> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$send_eip155_transaction_blocking(::com::crypto::game_sdk::Walletconnect2Client &self, ::com::crypto::game_sdk::WalletConnectTxEip155 const &info, ::std::array<::std::uint8_t, 20> *address, ::rust::Vec<::std::uint8_t> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$WalletconnectClient$sign_transaction(::com::crypto::game_sdk::WalletconnectClient &self, ::rust::String *eip1559_transaction_request, ::std::array<::std::uint8_t, 20> *address, ::rust::Vec<::std::uint8_t> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$sign_transaction(::com::crypto::game_sdk::Walletconnect2Client &self, ::rust::String *eip1559_transaction_request, ::std::array<::std::uint8_t, 20> *address, ::rust::Vec<::std::uint8_t> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$WalletconnectClient$send_transaction(::com::crypto::game_sdk::WalletconnectClient &self, ::rust::String *eip1559_transaction_request, ::std::array<::std::uint8_t, 20> *address, ::rust::Vec<::std::uint8_t> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$send_transaction(::com::crypto::game_sdk::Walletconnect2Client &self, ::rust::String *eip1559_transaction_request, ::std::array<::std::uint8_t, 20> *address, ::rust::Vec<::std::uint8_t> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$WalletconnectClient$sign_contract_transaction(::com::crypto::game_sdk::WalletconnectClient &self, ::rust::String *contract_action, ::com::crypto::game_sdk::WalletConnectTxCommon const &common, ::std::array<::std::uint8_t, 20> *address, ::rust::Vec<::std::uint8_t> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$sign_contract_transaction(::com::crypto::game_sdk::Walletconnect2Client &self, ::rust::String *contract_action, ::com::crypto::game_sdk::WalletConnectTxCommon const &common, ::std::array<::std::uint8_t, 20> *address, ::rust::Vec<::std::uint8_t> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$WalletconnectClient$send_contract_transaction(::com::crypto::game_sdk::WalletconnectClient &self, ::rust::String *contract_action, ::com::crypto::game_sdk::WalletConnectTxCommon const &common, ::std::array<::std::uint8_t, 20> *address, ::rust::Vec<::std::uint8_t> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$send_contract_transaction(::com::crypto::game_sdk::Walletconnect2Client &self, ::rust::String *contract_action, ::com::crypto::game_sdk::WalletConnectTxCommon const &common, ::std::array<::std::uint8_t, 20> *address, ::rust::Vec<::std::uint8_t> *return$) noexcept;
...
::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$get_token_holders(::rust::String *blockscout_base_url, ::rust::String *contract_address, ::std::uint64_t page, ::std::uint64_t offset, ::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail> *return$) noexcept;

::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$create_payment(::rust::String *secret_or_publishable_api_key, ::rust::String *base_unit_amount, ::rust::String *currency, ::com::crypto::game_sdk::OptionalArguments const &optional_args, ::com::crypto::game_sdk::CryptoComPaymentResponse *return$) noexcept;
...
::rust::repr::Fat com$crypto$game_sdk$cxxbridge1$OptionalArguments$get_description(::com::crypto::game_sdk::OptionalArguments const &self) noexcept {
...
::rust::repr::Fat com$crypto$game_sdk$cxxbridge1$OptionalArguments$get_metadata(::com::crypto::game_sdk::OptionalArguments const &self) noexcept {
...
::rust::repr::Fat com$crypto$game_sdk$cxxbridge1$OptionalArguments$get_order_id(::com::crypto::game_sdk::OptionalArguments const &self) noexcept {
...
::rust::repr::Fat com$crypto$game_sdk$cxxbridge1$OptionalArguments$get_return_url(::com::crypto::game_sdk::OptionalArguments const &self) noexcept {
...
::rust::repr::Fat com$crypto$game_sdk$cxxbridge1$OptionalArguments$get_cancel_url(::com::crypto::game_sdk::OptionalArguments const &self) noexcept {
...
::rust::repr::Fat com$crypto$game_sdk$cxxbridge1$OptionalArguments$get_sub_merchant_id(::com::crypto::game_sdk::OptionalArguments const &self) noexcept {
...
bool com$crypto$game_sdk$cxxbridge1$OptionalArguments$get_onchain_allowed(::com::crypto::game_sdk::OptionalArguments const &self) noexcept {
...
::std::uint64_t com$crypto$game_sdk$cxxbridge1$OptionalArguments$get_expired_at(::com::crypto::game_sdk::OptionalArguments const &self) noexcept {
...
bool TokenHolderDetail::operator==(TokenHolderDetail const &rhs) const noexcept {
  return com$crypto$game_sdk$cxxbridge1$TokenHolderDetail$operator$eq(*this, rhs);
}
...
::rust::Vec<::com::crypto::game_sdk::WalletEntry> filter_wallets(bool cached, ::rust::String registry_local_path, ::com::crypto::game_sdk::Platform platform) {
  ::rust::MaybeUninit<::rust::Vec<::com::crypto::game_sdk::WalletEntry>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$filter_wallets(cached, &registry_local_path, platform, &return$.value);
  if (error$.ptr) {
...
/// (`registry_local_path` can be empty string if it is not needed to store the `cached` registry result)
::rust::Vec<::com::crypto::game_sdk::WalletEntry> get_all_wallets(bool cached, ::rust::String registry_local_path) {
  ::rust::MaybeUninit<::rust::Vec<::com::crypto::game_sdk::WalletEntry>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$get_all_wallets(cached, &registry_local_path, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
/// (`registry_local_path` can be empty string if it is not needed to store the `cached` registry result)
bool check_wallet(bool cached, ::rust::String registry_local_path, ::rust::String id, ::com::crypto::game_sdk::Platform platform) {
  ::rust::MaybeUninit<bool> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$check_wallet(cached, &registry_local_path, &id, platform, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
/// Check wallet id at https://explorer.walletconnect.com/
/// (`registry_local_path` can be empty string if it is not needed to store the `cached` registry result)
::com::crypto::game_sdk::WalletEntry get_wallet(bool cached, ::rust::String registry_local_path, ::rust::String id) {
  ::rust::MaybeUninit<::com::crypto::game_sdk::WalletEntry> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$get_wallet(cached, &registry_local_path, &id, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::com::crypto::game_sdk::WalletQrcode generate_qrcode(::rust::String qrcodestring) {
  ::rust::MaybeUninit<::com::crypto::game_sdk::WalletQrcode> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$generate_qrcode(&qrcodestring, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Box<::com::crypto::game_sdk::Walletconnect2Client> walletconnect2_restore_client(::rust::String session_info) {
  ::rust::MaybeUninit<::rust::Box<::com::crypto::game_sdk::Walletconnect2Client>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$walletconnect2_restore_client(&session_info, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Box<::com::crypto::game_sdk::WalletconnectClient> walletconnect_new_client(::rust::String description, ::rust::String url, ::rust::Vec<::rust::String> icon_urls, ::rust::String name, ::std::uint64_t chain_id) {
  ::rust::ManuallyDrop<::rust::Vec<::rust::String>> icon_urls$(::std::move(icon_urls));
  ::rust::MaybeUninit<::rust::Box<::com::crypto::game_sdk::WalletconnectClient>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$walletconnect_new_client(&description, &url, &icon_urls$.value, &name, chain_id, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Box<::com::crypto::game_sdk::Walletconnect2Client> walletconnect2_client_new(::rust::String relayserver, ::rust::String project_id, ::rust::String required_namespaces, ::rust::String client_meta) {
  ::rust::MaybeUninit<::rust::Box<::com::crypto::game_sdk::Walletconnect2Client>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$walletconnect2_client_new(&relayserver, &project_id, &required_namespaces, &client_meta, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
void WalletconnectClient::setup_callback_blocking(::std::unique_ptr<::com::crypto::game_sdk::WalletConnectCallback> usercallback) {
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$WalletconnectClient$setup_callback_blocking(*this, usercallback.release());
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
}
...
::com::crypto::game_sdk::WalletConnect2EnsureSessionResult Walletconnect2Client::ensure_session_blocking(::std::uint64_t waitmillis) {
  ::rust::MaybeUninit<::com::crypto::game_sdk::WalletConnect2EnsureSessionResult> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$ensure_session_blocking(*this, waitmillis, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::String Walletconnect2Client::poll_events_blocking(::std::uint64_t waitmillis) {
  ::rust::MaybeUninit<::rust::String> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$poll_events_blocking(*this, waitmillis, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::String Walletconnect2Client::get_connection_string() {
  ::rust::MaybeUninit<::rust::String> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$get_connection_string(*this, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::String Walletconnect2Client::save_client() {
  ::rust::MaybeUninit<::rust::String> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$save_client(*this, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::String Walletconnect2Client::print_uri() {
  ::rust::MaybeUninit<::rust::String> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$print_uri(*this, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> Walletconnect2Client::sign_personal_blocking(::rust::String message, ::std::array<::std::uint8_t, 20> address) {
  ::rust::ManuallyDrop<::std::array<::std::uint8_t, 20>> address$(::std::move(address));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$sign_personal_blocking(*this, &message, &address$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::String Walletconnect2Client::ping_blocking(::std::uint64_t waitmillis) {
  ::rust::MaybeUninit<::rust::String> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$ping_blocking(*this, waitmillis, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> WalletconnectClient::sign_eip155_transaction_blocking(::com::crypto::game_sdk::WalletConnectTxEip155 const &info, ::std::array<::std::uint8_t, 20> address) {
  ::rust::ManuallyDrop<::std::array<::std::uint8_t, 20>> address$(::std::move(address));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$WalletconnectClient$sign_eip155_transaction_blocking(*this, info, &address$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> Walletconnect2Client::sign_eip155_transaction_blocking(::com::crypto::game_sdk::WalletConnectTxEip155 const &info, ::std::array<::std::uint8_t, 20> address) {
  ::rust::ManuallyDrop<::std::array<::std::uint8_t, 20>> address$(::std::move(address));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$sign_eip155_transaction_blocking(*this, info, &address$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> WalletconnectClient::send_eip155_transaction_blocking(::com::crypto::game_sdk::WalletConnectTxEip155 const &info, ::std::array<::std::uint8_t, 20> address) {
  ::rust::ManuallyDrop<::std::array<::std::uint8_t, 20>> address$(::std::move(address));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$WalletconnectClient$send_eip155_transaction_blocking(*this, info, &address$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> Walletconnect2Client::send_eip155_transaction_blocking(::com::crypto::game_sdk::WalletConnectTxEip155 const &info, ::std::array<::std::uint8_t, 20> address) {
  ::rust::ManuallyDrop<::std::array<::std::uint8_t, 20>> address$(::std::move(address));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$send_eip155_transaction_blocking(*this, info, &address$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> WalletconnectClient::sign_transaction(::rust::String eip1559_transaction_request, ::std::array<::std::uint8_t, 20> address) {
  ::rust::ManuallyDrop<::std::array<::std::uint8_t, 20>> address$(::std::move(address));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$WalletconnectClient$sign_transaction(*this, &eip1559_transaction_request, &address$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> Walletconnect2Client::sign_transaction(::rust::String eip1559_transaction_request, ::std::array<::std::uint8_t, 20> address) {
  ::rust::ManuallyDrop<::std::array<::std::uint8_t, 20>> address$(::std::move(address));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$sign_transaction(*this, &eip1559_transaction_request, &address$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> WalletconnectClient::send_transaction(::rust::String eip1559_transaction_request, ::std::array<::std::uint8_t, 20> address) {
  ::rust::ManuallyDrop<::std::array<::std::uint8_t, 20>> address$(::std::move(address));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$WalletconnectClient$send_transaction(*this, &eip1559_transaction_request, &address$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> Walletconnect2Client::send_transaction(::rust::String eip1559_transaction_request, ::std::array<::std::uint8_t, 20> address) {
  ::rust::ManuallyDrop<::std::array<::std::uint8_t, 20>> address$(::std::move(address));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$send_transaction(*this, &eip1559_transaction_request, &address$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> WalletconnectClient::sign_contract_transaction(::rust::String contract_action, ::com::crypto::game_sdk::WalletConnectTxCommon const &common, ::std::array<::std::uint8_t, 20> address) {
  ::rust::ManuallyDrop<::std::array<::std::uint8_t, 20>> address$(::std::move(address));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$WalletconnectClient$sign_contract_transaction(*this, &contract_action, common, &address$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> Walletconnect2Client::sign_contract_transaction(::rust::String contract_action, ::com::crypto::game_sdk::WalletConnectTxCommon const &common, ::std::array<::std::uint8_t, 20> address) {
  ::rust::ManuallyDrop<::std::array<::std::uint8_t, 20>> address$(::std::move(address));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$sign_contract_transaction(*this, &contract_action, common, &address$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> WalletconnectClient::send_contract_transaction(::rust::String contract_action, ::com::crypto::game_sdk::WalletConnectTxCommon const &common, ::std::array<::std::uint8_t, 20> address) {
  ::rust::ManuallyDrop<::std::array<::std::uint8_t, 20>> address$(::std::move(address));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$WalletconnectClient$send_contract_transaction(*this, &contract_action, common, &address$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::std::uint8_t> Walletconnect2Client::send_contract_transaction(::rust::String contract_action, ::com::crypto::game_sdk::WalletConnectTxCommon const &common, ::std::array<::std::uint8_t, 20> address) {
  ::rust::ManuallyDrop<::std::array<::std::uint8_t, 20>> address$(::std::move(address));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$Walletconnect2Client$send_contract_transaction(*this, &contract_action, common, &address$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail> get_token_holders(::rust::String blockscout_base_url, ::rust::String contract_address, ::std::uint64_t page, ::std::uint64_t offset) {
  ::rust::MaybeUninit<::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail>> return$;
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$get_token_holders(&blockscout_base_url, &contract_address, page, offset, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::com::crypto::game_sdk::CryptoComPaymentResponse create_payment(::rust::String secret_or_publishable_api_key, ::rust::String base_unit_amount, ::rust::String currency, ::com::crypto::game_sdk::OptionalArguments const &optional_args) {
...
::com::crypto::game_sdk::WalletConnectSessionInfo const *cxxbridge1$unique_ptr$com$crypto$game_sdk$WalletConnectSessionInfo$get(::std::unique_ptr<::com::crypto::game_sdk::WalletConnectSessionInfo> const &ptr) noexcept {
  return ptr.get();
}
...
void cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnectAddress$new(::rust::Vec<::com::crypto::game_sdk::WalletConnectAddress> const *ptr) noexcept;
...
::std::size_t cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnectAddress$len(::rust::Vec<::com::crypto::game_sdk::WalletConnectAddress> const *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnectAddress$capacity(::rust::Vec<::com::crypto::game_sdk::WalletConnectAddress> const *ptr) noexcept;
::com::crypto::game_sdk::WalletConnectAddress const *cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnectAddress$data(::rust::Vec<::com::crypto::game_sdk::WalletConnectAddress> const *ptr) noexcept;
...
void cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$new(::rust::Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts> const *ptr) noexcept;
void cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$drop(::rust::Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts> *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$len(::rust::Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts> const *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$capacity(::rust::Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts> const *ptr) noexcept;
::com::crypto::game_sdk::WalletConnect2Eip155Accounts const *cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$data(::rust::Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts> const *ptr) noexcept;
void cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$reserve_total(::rust::Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts> *ptr, ::std::size_t new_cap) noexcept;
void cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$set_len(::rust::Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts> *ptr, ::std::size_t len) noexcept;
void cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$truncate(::rust::Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts> *ptr, ::std::size_t len) noexcept;

void cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$new(::rust::Vec<::com::crypto::game_sdk::WalletEntry> const *ptr) noexcept;
void cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$drop(::rust::Vec<::com::crypto::game_sdk::WalletEntry> *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$len(::rust::Vec<::com::crypto::game_sdk::WalletEntry> const *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$capacity(::rust::Vec<::com::crypto::game_sdk::WalletEntry> const *ptr) noexcept;
::com::crypto::game_sdk::WalletEntry const *cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$data(::rust::Vec<::com::crypto::game_sdk::WalletEntry> const *ptr) noexcept;
void cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$reserve_total(::rust::Vec<::com::crypto::game_sdk::WalletEntry> *ptr, ::std::size_t new_cap) noexcept;
void cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$set_len(::rust::Vec<::com::crypto::game_sdk::WalletEntry> *ptr, ::std::size_t len) noexcept;
void cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$truncate(::rust::Vec<::com::crypto::game_sdk::WalletEntry> *ptr, ::std::size_t len) noexcept;
...
::com::crypto::game_sdk::Walletconnect2Client *cxxbridge1$box$com$crypto$game_sdk$Walletconnect2Client$alloc() noexcept;
void cxxbridge1$box$com$crypto$game_sdk$Walletconnect2Client$dealloc(::com::crypto::game_sdk::Walletconnect2Client *) noexcept;
void cxxbridge1$box$com$crypto$game_sdk$Walletconnect2Client$drop(::rust::Box<::com::crypto::game_sdk::Walletconnect2Client> *ptr) noexcept;
...
::com::crypto::game_sdk::WalletConnectCallback const *cxxbridge1$unique_ptr$com$crypto$game_sdk$WalletConnectCallback$get(::std::unique_ptr<::com::crypto::game_sdk::WalletConnectCallback> const &ptr) noexcept {
  return ptr.get();
}
...
void cxxbridge1$rust_vec$com$crypto$game_sdk$RawTxDetail$new(::rust::Vec<::com::crypto::game_sdk::RawTxDetail> const *ptr) noexcept;
void cxxbridge1$rust_vec$com$crypto$game_sdk$RawTxDetail$drop(::rust::Vec<::com::crypto::game_sdk::RawTxDetail> *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$com$crypto$game_sdk$RawTxDetail$len(::rust::Vec<::com::crypto::game_sdk::RawTxDetail> const *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$com$crypto$game_sdk$RawTxDetail$capacity(::rust::Vec<::com::crypto::game_sdk::RawTxDetail> const *ptr) noexcept;
::com::crypto::game_sdk::RawTxDetail const *cxxbridge1$rust_vec$com$crypto$game_sdk$RawTxDetail$data(::rust::Vec<::com::crypto::game_sdk::RawTxDetail> const *ptr) noexcept;
...
void cxxbridge1$rust_vec$com$crypto$game_sdk$RawTokenResult$new(::rust::Vec<::com::crypto::game_sdk::RawTokenResult> const *ptr) noexcept;
...
::std::size_t cxxbridge1$rust_vec$com$crypto$game_sdk$RawTokenResult$len(::rust::Vec<::com::crypto::game_sdk::RawTokenResult> const *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$com$crypto$game_sdk$RawTokenResult$capacity(::rust::Vec<::com::crypto::game_sdk::RawTokenResult> const *ptr) noexcept;
::com::crypto::game_sdk::RawTokenResult const *cxxbridge1$rust_vec$com$crypto$game_sdk$RawTokenResult$data(::rust::Vec<::com::crypto::game_sdk::RawTokenResult> const *ptr) noexcept;
...
void cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$new(::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail> const *ptr) noexcept;
void cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$drop(::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail> *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$len(::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail> const *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$capacity(::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail> const *ptr) noexcept;
::com::crypto::game_sdk::TokenHolderDetail const *cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$data(::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail> const *ptr) noexcept;
void cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$reserve_total(::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail> *ptr, ::std::size_t new_cap) noexcept;
void cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$set_len(::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail> *ptr, ::std::size_t len) noexcept;
void cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$truncate(::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail> *ptr, ::std::size_t len) noexcept;
} // extern "C"
...
template <>
::com::crypto::game_sdk::WalletConnectAddress const *Vec<::com::crypto::game_sdk::WalletConnectAddress>::data() const noexcept {
...
Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts>::Vec() noexcept {
  cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$new(this);
}
template <>
void Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts>::drop() noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$drop(this);
}
template <>
::std::size_t Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts>::size() const noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$len(this);
}
template <>
::std::size_t Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts>::capacity() const noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$capacity(this);
}
template <>
::com::crypto::game_sdk::WalletConnect2Eip155Accounts const *Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts>::data() const noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$data(this);
}
template <>
void Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts>::reserve_total(::std::size_t new_cap) noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$reserve_total(this, new_cap);
}
template <>
void Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts>::set_len(::std::size_t len) noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$set_len(this, len);
}
template <>
void Vec<::com::crypto::game_sdk::WalletConnect2Eip155Accounts>::truncate(::std::size_t len) {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$WalletConnect2Eip155Accounts$truncate(this, len);
}
template <>
Vec<::com::crypto::game_sdk::WalletEntry>::Vec() noexcept {
  cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$new(this);
}
template <>
void Vec<::com::crypto::game_sdk::WalletEntry>::drop() noexcept {
...
template <>
::std::size_t Vec<::com::crypto::game_sdk::WalletEntry>::capacity() const noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$capacity(this);
}
template <>
::com::crypto::game_sdk::WalletEntry const *Vec<::com::crypto::game_sdk::WalletEntry>::data() const noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$data(this);
}
template <>
void Vec<::com::crypto::game_sdk::WalletEntry>::reserve_total(::std::size_t new_cap) noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$reserve_total(this, new_cap);
}
template <>
void Vec<::com::crypto::game_sdk::WalletEntry>::set_len(::std::size_t len) noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$set_len(this, len);
}
template <>
void Vec<::com::crypto::game_sdk::WalletEntry>::truncate(::std::size_t len) {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$WalletEntry$truncate(this, len);
}
template <>
...
template <>
::com::crypto::game_sdk::Walletconnect2Client *Box<::com::crypto::game_sdk::Walletconnect2Client>::allocation::alloc() noexcept {
  return cxxbridge1$box$com$crypto$game_sdk$Walletconnect2Client$alloc();
}
template <>
void Box<::com::crypto::game_sdk::Walletconnect2Client>::allocation::dealloc(::com::crypto::game_sdk::Walletconnect2Client *ptr) noexcept {
...
template <>
::com::crypto::game_sdk::RawTxDetail const *Vec<::com::crypto::game_sdk::RawTxDetail>::data() const noexcept {
...
template <>
::com::crypto::game_sdk::RawTokenResult const *Vec<::com::crypto::game_sdk::RawTokenResult>::data() const noexcept {
...
template <>
Vec<::com::crypto::game_sdk::TokenHolderDetail>::Vec() noexcept {
...
template <>
::std::size_t Vec<::com::crypto::game_sdk::TokenHolderDetail>::size() const noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$len(this);
}
template <>
::std::size_t Vec<::com::crypto::game_sdk::TokenHolderDetail>::capacity() const noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$capacity(this);
}
template <>
::com::crypto::game_sdk::TokenHolderDetail const *Vec<::com::crypto::game_sdk::TokenHolderDetail>::data() const noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$data(this);
}
template <>
void Vec<::com::crypto::game_sdk::TokenHolderDetail>::reserve_total(::std::size_t new_cap) noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$reserve_total(this, new_cap);
}
template <>
void Vec<::com::crypto::game_sdk::TokenHolderDetail>::set_len(::std::size_t len) noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$set_len(this, len);
}
template <>
void Vec<::com::crypto::game_sdk::TokenHolderDetail>::truncate(::std::size_t len) {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$truncate(this, len);
}
} // namespace cxxbridge1
} // namespace rust
