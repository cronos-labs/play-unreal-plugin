...
get_token_holders(::rust::String blockscout_base_url,
  ...
  ::rust::MaybeUninit<::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail>>
      return$;
  ::rust::repr::PtrLen error$ =
      com$crypto$game_sdk$cxxbridge1$get_token_holders(&blockscout_base_url,
                                                       &contract_address, page,
                                                       offset, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
...
void cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$new(
    const ::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail>
        *ptr) noexcept;
...
cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$capacity(
    const ::rust::Vec<::com::crypto::game_sdk::TokenHolderDetail>
        *ptr) noexcept;
const ::com::crypto::game_sdk::TokenHolderDetail *
...
void Vec<::com::crypto::game_sdk::TokenHolderDetail>::set_len(
    ::std::size_t len) noexcept {
  return cxxbridge1$rust_vec$com$crypto$game_sdk$TokenHolderDetail$set_len(this,
                                                                           len);
}
template <>
