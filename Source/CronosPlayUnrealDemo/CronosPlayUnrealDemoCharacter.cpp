...
void ACronosPlayUnrealDemoCharacter::SetupPlayerInputComponent(
  ...
  PlayerInputComponent->BindAxis("MoveForward", this,
                                 &ACronosPlayUnrealDemoCharacter::MoveForward);
  ...
  PlayerInputComponent->BindAxis("LookUpRate", this,
                                 &ACronosPlayUnrealDemoCharacter::LookUpAtRate);
...
void ACronosPlayUnrealDemoCharacter::OnResetVR() {
  ...
  // CronosPlayUnrealDemo.Build.cs is not automatically propagated and a linker
  // error will result. You will need to either:
