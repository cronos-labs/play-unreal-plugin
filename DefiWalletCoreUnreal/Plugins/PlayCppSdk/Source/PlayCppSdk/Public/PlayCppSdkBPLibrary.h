...
public:
  ...
  UFUNCTION(BlueprintCallable,
            meta = (DisplayName = "GetErc20TransferHistoryBlocking",
                    Keywords = "playcppsdk cronoscan"),
            Category = "PlayCppSdk")
  static void GetErc20TransferHistoryBlocking(FString address,
                                              FString ContractAddress,
                                              EQueryOption option,
                                              FString api_key,
                                              TArray<FRawTxDetail> &output,
  ...
  UFUNCTION(BlueprintCallable,
            meta = (DisplayName = "GetErc721TransferHistoryBlocking",
                    Keywords = "playcppsdk cronoscan"),
            Category = "PlayCppSdk")
  static void GetErc721TransferHistoryBlocking(FString address,
                                               FString ContractAddress,
                                               EQueryOption option,
                                               FString api_key,
                                               TArray<FRawTxDetail> &output,
  ...
  UFUNCTION(BlueprintCallable,
            meta = (DisplayName = "GetTokensBlocking",
                    Keywords = "playcppsdk blockscout"),
            Category = "PlayCppSdk")
