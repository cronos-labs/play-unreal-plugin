...
extern "C" {
::com::crypto::game_sdk::WalletConnectCallback *com$crypto$game_sdk$cxxbridge1$new_walletconnect_callback() noexcept {
  ::std::unique_ptr<::com::crypto::game_sdk::WalletConnectCallback> (*new_walletconnect_callback$)() = ::com::crypto::game_sdk::new_walletconnect_callback;
  return new_walletconnect_callback$().release();
}
...
::rust::repr::PtrLen com$crypto$game_sdk$cxxbridge1$WalletconnectClient$setup_callback(::com::crypto::game_sdk::WalletconnectClient &self) noexcept;
...
void WalletconnectClient::setup_callback() {
  ::rust::repr::PtrLen error$ = com$crypto$game_sdk$cxxbridge1$WalletconnectClient$setup_callback(*this);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
}
